...
public class yearningPhoto {
	public static void main(String[] args) throws IOException {
		...
		String[][] photo = new String[][] {{"kali", "mari", "don"}, {"pony", "tom", "teddy"}, {"con", "mona", "don"}};
		// String[][] photo = new String[][] {{"may", "kein", "kain", "radi"},
		// 	{"may", "kein", "brin", "deny"},
		// 	{"kon", "kain", "may", "coni"}};

		System.out.println(Arrays.toString(solution(names, yearning, photo)));
	}
